...
def fix():
    ...
    # 1. Remove duplicate declarations and potentially broken fragments
    content = content.replace('let mapLastTap = 0;', '')
    content = content.replace('let mapLastTap=0;', '')
...
"""
    ...
    # 3. Clean all occurrences of functions
    def remove_func(name, text):
        # Greedily match functions with balanced braces
    ...
    # 4. Inject clean functions at the bottom of the script
